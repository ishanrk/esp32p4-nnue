...
export function HowItWorks() {
  return <Page title="Engine guide">
    ...
    <Section title="Board representation" id="guide-rules">
    ...
    <Section title="Search trees and alpha beta" id="guide-search">
    ...
    <Section title="NNUE evaluation" id="guide-inference">
    ...
    <Section title="Source reading order" id="guide-files">
